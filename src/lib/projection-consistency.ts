 ...
 * estimates from two different runs, and on 236 of 314 areas the projection falls
 * outside the interval printed beside it. Burnley shipped "80% CI: 46.4, 50.8%" next to
 * a projection of 43.1%. At the extremes the stochastic series is itself implausible:
 * Isles of Scilly, about 97% White British, carried an interval of 1.1 to 3.1%.
 *
 * Which series is right is an open question that cannot be settled until the model is
 * reproducible from the data bank, so this does not pick a winner and does not change
