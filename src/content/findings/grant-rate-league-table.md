---
headline: "Yemen 95%, India 3% — the grant rate gap the Home Office won't publish as a league table"
date: "2026-04-14"
category: routes
stat_value: "107"
stat_label: "Nationalities assessed"
verdict: alert
...
summary: "We built the first comprehensive grant rate league table from Home Office decision data. 11 nationalities have 75%+ initial grant rates (genuine refugees). 41 have under 25% — their claims are overwhelmingly refused. The gap between the two groups is the clearest evidence that the asylum system processes both genuine refugees and economic migrants, but treats them identically until decision."
---
