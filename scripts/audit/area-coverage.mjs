...
const DATASETS = [
  ...
  { id: "area-series", tier: "broad", scope: "UK time series",
    codes: (d) => fromList(d) },
  { id: "ethnic-projections", tier: "national", scope: "England and Wales (Hamilton-Perry model)",
    codes: (d) => fromKeys(d.areas) },
  { id: "scenario-summaries", tier: "national", scope: "England and Wales, model scenarios",
    codes: (d) => fromKeys(d.areas) },
